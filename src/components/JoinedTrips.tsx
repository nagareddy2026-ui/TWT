          ...
          >
            ...
            <div className="mt-6 flex gap-3">
              <button
                ...
                className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-full text-sm font-semibold"
              >
                🚪 Leave Trip
              </button>

              <span className="bg-green-500/80 px-4 py-2 rounded-full text-sm font-semibold">
                Joined ✅
              </span>
            </div>
